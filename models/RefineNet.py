...
def rf101(num_classes=1):
    model = RefineNet(Bottleneck, [3, 4, 23, 3], num_classes=num_classes)
    model.load_state_dict(torch.load("../resnet101-5d3b4d8f.pth"), strict=False)
    return model
