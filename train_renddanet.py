...
from models import AUNet, AUNet_R16, DANet, R2UNet, SEUNet, UNetPP, UNet, RendDANet
from data_loader import get_dataloader
from util import dice_coeff, get_accuracy, get_specificity, get_sensitivity, get_precision, get_F1
from loss import DiceLoss, MixLoss, RendLoss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type', type=str, default='RendDANet', help='UNet/R2UNet/AUNet/R2AUNet/SEUNet/SEUNet++/UNet++/DAUNet/DANet/AUNetR/RendDANet')
