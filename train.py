...
from models import AUNet, AUNet_R16, DANet, R2UNet, SEUNet, UNetPP, UNet, RendDANet, BASNet, RDSN
...
def train_val(config):
    ...
    if config.model_type not in ['UNet', 'R2UNet', 'AUNet', 'R2AUNet', 'SEUNet', 'SEUNet++', 'UNet++',
                                 'DAUNet', 'DANet', 'AUNetR', 'RendDANet', "BASNet", "RendUNet", "Model1", 'RDSN']:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type', type=str, default='RDSN', help='UNet/R2UNet/AUNet/SEUNet/UNet++/DANet/AUNetR')
    parser.add_argument('--data_type', type=str, default='multi', help='single/multi')
    parser.add_argument('--loss', type=str, default='bce', help='bce/dice/mix')
